  ...
  return (
    <div className="min-h-[60vh] grid place-items-center px-6">
      <div className="max-w-[460px] text-center">
        ...
        <h1 className="font-serif text-h1 font-semibold leading-tight">Something broke on this surface.</h1>
        <p className="mt-3 text-body leading-relaxed text-muted">
          The work you’d done isn’t lost — this view just failed to render. Try again, or head back to the dashboard.
        </p>
        {error.digest && <p className="mt-3 font-mono text-meta text-faint">ref: {error.digest}</p>}
        <div className="mt-6 flex items-center justify-center gap-3">
          ...
          <Link
            href="/dashboard"
            className="font-mono text-meta uppercase tracking-[0.12em] border border-hairline-2 text-muted px-4 py-2 rounded-lg hover:border-ink hover:text-ink transition-colors"
          >
            Dashboard
          </Link>
        </div>
